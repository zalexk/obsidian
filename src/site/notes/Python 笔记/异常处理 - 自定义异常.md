---
{"dg-publish":true,"permalink":"/python//","tags":["Python异常处理"],"created":"2026-07-06T00:36:48.892+08:00","updated":"2026-08-29T02:06:07.905+08:00","dg-note-properties":{"tags":["Python异常处理"]}}
---
...
出现异常时我们一方面要转换为自定义异常，另外一方面本身的异常信息也不应该丢失，因此我们要使用 `raise ... from ...` 语法 （见 [[Python 笔记/异常处理 - raise ... from ... 语法\|异常处理 - raise ... from ... 语法]]）
``` python
